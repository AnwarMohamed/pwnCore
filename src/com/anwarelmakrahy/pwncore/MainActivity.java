...
import com.anwarelmakrahy.pwncore.structures.SidebarSessionsAdapter;
...
public class MainActivity extends Activity implements OnQueryTextListener {
		...
		modulesList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (isConnected
					...
					Toast.makeText(getApplicationContext(),
							R.string.pwncore_notconnected, Toast.LENGTH_SHORT)
							.show();
				}
			}
		});
	...
	public void onResume() {
		if (!conStatusReceiverRegistered) {
			...
			filter.addAction(StaticClass.PWNCORE_SERVICE_STARTED);
	...
	public BroadcastReceiver conStatusReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action == StaticClass.PWNCORE_SERVICE_STARTED) {
			...
			} else if (action == StaticClass.PWNCORE_CONNECTION_TIMEOUT) {
				Disconnect();
				Toast.makeText(getApplicationContext(),
						R.string.pwncore_connectiontimeout, Toast.LENGTH_SHORT)
						.show();
				...
				Toast.makeText(getApplicationContext(),
						R.string.pwncore_connectionfailed, Toast.LENGTH_SHORT)
						.show();
	...
	private void setNotification() {
		...
		noti = new Notification.Builder(getApplicationContext()).setWhen(0)
				.setContentTitle("pwnCore").setContentText(notiText)
